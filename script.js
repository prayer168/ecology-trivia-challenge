const questionSets = {
  ...
  boss: [
    {
      topic: "氣候科學",
      question: "氣候敏感度通常用來描述哪一種關係？",
      choices: ["二氧化碳倍增與升溫反應", "海浪高度與月相變化", "地震規模與降雨量關係", "風速變化與土壤顏色"],
      answer: 0,
      explain: "氣候敏感度常指大氣二氧化碳濃度倍增後，全球平均溫度可能上升的幅度。"
    },
    {
      topic: "碳循環",
      question: "森林碳匯被計算時，最需要避免哪一種問題？",
      choices: ["重複計算同一吸收量", "完全忽略樹木生長", "只統計葉片顏色", "把降雨量當排放量"],
      answer: 0,
      explain: "碳匯計算需避免重複計算、永久性不足與額外性不明等問題。"
    },
    {
      topic: "環境毒理",
      question: "劑量反應關係主要用來判斷什麼？",
      choices: ["暴露量與效應強度關係", "物種名稱與棲地形狀", "河川長度與流域人口", "回收標誌與產品價格"],
      answer: 0,
      explain: "毒理評估會關注暴露劑量增加時，生物反應或健康效應如何改變。"
    },
    {
      topic: "水質管理",
      question: "總最大日負荷量 TMDL 的管理重點是什麼？",
      choices: ["限制水體可承受污染負荷", "增加河道混凝土比例", "提高水體每日取水量", "統一所有河川深度"],
      answer: 0,
      explain: "TMDL 用來估算水體可承受的污染量，並分配污染削減責任。"
    },
    {
      topic: "生態統計",
      question: "物種豐富度和均勻度都會影響哪一類指標？",
      choices: ["生物多樣性指數", "空氣品質副指標", "噪音分貝平均值", "廢棄物含水比例"],
      answer: 0,
      explain: "多樣性指數通常同時受到物種數量和各物種個體分布是否均勻影響。"
    },
    {
      topic: "環境法規",
      question: "環評承諾事項在管理上最重要的意義是什麼？",
      choices: ["成為後續追蹤監督依據", "可取代所有法規要求", "只作為宣傳口號使用", "使開發案免除監測"],
      answer: 0,
      explain: "環評承諾需落實並接受追蹤，否則環境影響評估會失去實質約束力。"
    },
    {
      topic: "海岸管理",
      question: "海岸藍碳生態系通常不包含哪一類系統？",
      choices: ["高山針葉林", "紅樹林濕地", "海草床生態系", "鹽沼濕地環境"],
      answer: 0,
      explain: "藍碳多指紅樹林、鹽沼、海草床等海岸或海洋生態系的碳儲存功能。"
    },
    {
      topic: "能源轉型",
      question: "再生能源併網常需要搭配哪一種措施？",
      choices: ["儲能與電網調度", "提高燃煤補貼比例", "取消所有需求管理", "固定每日尖峰用電"],
      answer: 0,
      explain: "太陽能與風力具間歇性，需要儲能、需量反應與電網調度提高穩定性。"
    },
    {
      topic: "土壤修復",
      question: "植生復育法較適合哪一類污染整治情境？",
      choices: ["低濃度且可長期處理場址", "立即移除所有污染場址", "只處理空氣噪音問題", "完全無植物生長條件"],
      answer: 0,
      explain: "植生復育成本較低但速度慢，適用性取決於污染物種類、濃度與場址條件。"
    },
    {
      topic: "都市韌性",
      question: "海綿城市設計主要想改善哪一項問題？",
      choices: ["雨水滯留入滲與逕流管理", "建築高度統一與外觀一致", "道路車速提升與停車增加", "夜間照明亮度全面提高"],
      answer: 0,
      explain: "海綿城市透過透水鋪面、滯洪池、綠地等設施提升都市雨洪管理能力。"
    },
    {
      topic: "空污控制",
      question: "選擇性觸媒還原 SCR 常用於控制哪類污染物？",
      choices: ["氮氧化物排放", "塑膠微粒排放", "水體懸浮固體", "土壤重金屬量"],
      answer: 0,
      explain: "SCR 常以觸媒和還原劑將氮氧化物轉化為氮氣與水。"
    },
    {
      topic: "生態模型",
      question: "族群承載量 K 主要表示什麼？",
      choices: ["環境可支持的族群上限", "單一個體最大壽命", "每次繁殖固定幼體數", "掠食者移動最高速度"],
      answer: 0,
      explain: "承載量描述在特定資源與環境限制下，族群可長期維持的大致規模。"
    },
    {
      topic: "保育規劃",
      question: "保護區系統規劃常強調代表性，是指什麼？",
      choices: ["涵蓋不同生態系與物種", "只選最容易管理地區", "只保護單一明星物種", "避開所有棲地連結"],
      answer: 0,
      explain: "代表性確保不同棲地型、生態系與物種都被納入保護，而非只保護少數地點。"
    },
    {
      topic: "污染監測",
      question: "被動式採樣器的常見優點是什麼？",
      choices: ["可反映一段期間平均暴露", "只能測得瞬間最高濃度", "不需校正即可任意比較", "可完全取代所有實驗室分析"],
      answer: 0,
      explain: "被動採樣常用來累積一段時間的污染訊號，適合監測長期或低濃度暴露。"
    },
    {
      topic: "生態恢復",
      question: "恢復生態學中的參考生態系有何用途？",
      choices: ["提供復育目標與比較基準", "保證復育後完全相同", "取代所有現地調查", "只用來美化報告版面"],
      answer: 0,
      explain: "參考生態系可協助設定目標，但實際復育仍需考量現地條件與氣候變遷。"
    },
    {
      topic: "環境經濟",
      question: "外部成本內部化的核心概念是什麼？",
      choices: ["讓決策者承擔環境成本", "讓污染成本由他人吸收", "把成本完全排除價格外", "只計算商品包裝成本"],
      answer: 0,
      explain: "內部化外部成本能讓污染或資源耗損反映在價格與決策中。"
    },
    {
      topic: "氣候風險",
      question: "轉型風險通常和哪一項變化較相關？",
      choices: ["政策技術與市場轉變", "海底地形自然起伏", "月相週期固定變化", "土壤粒徑自然排序"],
      answer: 0,
      explain: "轉型風險來自低碳轉型中的政策、技術、法律、市場與聲譽變化。"
    },
    {
      topic: "水循環",
      question: "地下水超抽最可能造成哪一種長期問題？",
      choices: ["地層下陷與水源枯竭", "臭氧濃度立即降低", "森林授粉效率提高", "海水酸化快速停止"],
      answer: 0,
      explain: "地下水長期抽取超過補注量，可能導致地下水位下降、地層下陷或海水入侵。"
    },
    {
      topic: "環境正義",
      question: "環境正義最重視哪一項原則？",
      choices: ["風險與利益分配公平", "污染集中於弱勢地區", "資訊只給少數人掌握", "決策排除受影響居民"],
      answer: 0,
      explain: "環境正義關注環境負擔、決策參與與資訊取得是否公平。"
    },
    {
      topic: "生物地理",
      question: "島嶼生物地理學常用來解釋什麼？",
      choices: ["面積隔離與物種數關係", "河川酸鹼與濁度關係", "噪音分貝與睡眠關係", "能源價格與消費關係"],
      answer: 0,
      explain: "島嶼生物地理學指出面積、隔離距離、移入與滅絕率會影響物種數量。"
    }
  ],
  master: [
    {
      topic: "氣候模型",
      question: "輻射強迫為正值時，通常代表什麼趨勢？",
      choices: ["地球系統傾向吸收更多能量", "地表反照率必定升高", "海洋完全停止吸熱", "大氣水氣立即歸零"],
      answer: 0,
      explain: "正輻射強迫表示進出能量收支偏向增暖，是分析氣候變化的重要概念。"
    },
    {
      topic: "生命週期評估",
      question: "LCA 中設定功能單位的主要目的為何？",
      choices: ["讓不同產品可公平比較", "只增加報告文字長度", "排除使用階段影響", "避免蒐集原料資料"],
      answer: 0,
      explain: "功能單位定義比較基準，例如每公里運輸或每次清洗，避免比較失真。"
    },
    {
      topic: "碳盤查",
      question: "範疇三排放最常見的挑戰是什麼？",
      choices: ["供應鏈資料取得與邊界界定", "廠內電表完全無法讀取", "直接燃燒排放不存在", "所有資料都可即時量測"],
      answer: 0,
      explain: "範疇三涉及上下游活動，資料品質、邊界設定與重複計算都是主要挑戰。"
    },
    {
      topic: "生態網絡",
      question: "食物網中的模組化程度提高，可能代表什麼？",
      choices: ["群聚內互動較密集", "所有物種只吃同一食物", "能量不再需要流動", "掠食關係全部消失"],
      answer: 0,
      explain: "模組化表示網絡中存在互動較密集的子群，可能影響擾動傳播方式。"
    },
    {
      topic: "保育優先性",
      question: "系統性保育規劃中互補性強調什麼？",
      choices: ["新增地點補足既有保護缺口", "每個保護區都完全相同", "只選面積最大的地點", "忽略物種分布差異"],
      answer: 0,
      explain: "互補性重視新增保護區能補足哪些尚未被保護的物種、棲地或功能。"
    },
    {
      topic: "污染化學",
      question: "污染物半衰期長通常代表什麼環境意義？",
      choices: ["在環境中較不易降解", "會立即變成無害物", "只會存在一秒鐘", "無法被任何方式偵測"],
      answer: 0,
      explain: "半衰期越長，污染物可能在環境中停留越久，增加長距離傳輸或累積風險。"
    },
    {
      topic: "水資源治理",
      question: "整合流域管理最核心的單位通常是什麼？",
      choices: ["以流域作為管理範圍", "以單一行政區為唯一範圍", "以道路寬度作為範圍", "以建築高度作為範圍"],
      answer: 0,
      explain: "水文過程依流域連結，管理若只看行政界線容易忽略上下游影響。"
    },
    {
      topic: "環境健康",
      question: "累積暴露評估比單次測量更適合回答哪類問題？",
      choices: ["長期接觸造成的健康風險", "當下風向的一秒變化", "某一天的商品價格", "單一葉片的形狀差異"],
      answer: 0,
      explain: "許多慢性風險與長期低劑量暴露有關，單次測量不足以反映完整風險。"
    },
    {
      topic: "環境政策",
      question: "預防原則適用於哪一種決策情境？",
      choices: ["科學不確定但可能有重大危害", "完全沒有任何風險可能", "已證明危害不存在", "只涉及商品包裝顏色"],
      answer: 0,
      explain: "預防原則主張在可能有嚴重或不可逆危害時，不應因不確定性而延後行動。"
    },
    {
      topic: "氣候調適",
      question: "調適路徑規劃強調什麼？",
      choices: ["依風險變化分階段調整策略", "一次選定永不改變措施", "只採用最便宜短期方案", "完全不需要監測資料"],
      answer: 0,
      explain: "調適路徑讓決策可隨氣候風險、社會條件與監測結果逐步調整。"
    },
    {
      topic: "生態系服務",
      question: "生態系服務評估中常見的權衡是什麼？",
      choices: ["供給服務提升可能壓縮調節服務", "所有服務必定同步增加", "文化服務永遠可量化", "調節服務與土地利用無關"],
      answer: 0,
      explain: "例如提高農作產量可能犧牲棲地、水質或碳吸存，需要分析服務間的權衡。"
    },
    {
      topic: "海洋治理",
      question: "海洋空間規劃 MSP 的主要功能是什麼？",
      choices: ["協調不同海域使用與保育需求", "取消所有海域管理規則", "只規範沙灘遊客服裝", "讓捕撈活動完全不受限"],
      answer: 0,
      explain: "MSP 用空間方式協調漁業、航運、能源、保育與觀光等海域使用。"
    },
    {
      topic: "入侵生物",
      question: "入侵種早期偵測快速反應 EDRR 的價值是什麼？",
      choices: ["在擴散前降低控制成本", "等全面擴散後再處理", "只記錄不採取管理行動", "保證所有外來種都有害"],
      answer: 0,
      explain: "入侵初期族群小、範圍有限，及早處理通常比擴散後控制更有效。"
    },
    {
      topic: "空氣化學",
      question: "二次氣膠的形成通常涉及什麼過程？",
      choices: ["氣態前驅物反應生成粒狀物", "大型垃圾破碎成塑膠瓶", "土壤直接變成臭氧", "降雨完全轉化成氧氣"],
      answer: 0,
      explain: "硫氧化物、氮氧化物、揮發性有機物等可經化學反應形成二次粒狀污染物。"
    },
    {
      topic: "環境資料",
      question: "監測資料品質保證 QA/QC 最主要目的為何？",
      choices: ["確保資料可靠可追溯", "讓數據永遠不能公開", "避免儀器進行校正", "只保留符合預期資料"],
      answer: 0,
      explain: "QA/QC 可透過校正、空白樣、重複樣與紀錄管理提升資料可信度。"
    },
    {
      topic: "廢棄物治理",
      question: "廢棄物階層中最優先的策略通常是什麼？",
      choices: ["源頭減量避免產生", "直接掩埋所有物品", "先焚化再考慮減量", "只依賴末端清理"],
      answer: 0,
      explain: "避免廢棄物產生通常優先於再使用、回收、能源回收與最終處置。"
    },
    {
      topic: "環境倫理",
      question: "世代正義在環境議題中主要關注什麼？",
      choices: ["當代行為對未來世代影響", "只保障目前消費便利", "排除長期資源限制", "忽略不可逆環境損害"],
      answer: 0,
      explain: "世代正義提醒現代人使用資源與承擔風險時，需考量未來世代的權益。"
    },
    {
      topic: "生物多樣性",
      question: "功能多樣性與物種數相比，多補充了哪一類資訊？",
      choices: ["物種在生態功能上的差異", "每個物種名稱長短", "採樣日期是否相同", "研究者使用的字體"],
      answer: 0,
      explain: "功能多樣性描述物種特徵與生態角色差異，可補足單看物種數的不足。"
    },
    {
      topic: "氣候金融",
      question: "漂綠風險在永續金融中指的是什麼？",
      choices: ["環境宣稱高於實際作為", "完全揭露所有環境風險", "確實達成減碳目標", "主動降低投資排放"],
      answer: 0,
      explain: "漂綠會誤導投資者或消費者，使資金流向未真正改善環境表現的活動。"
    },
    {
      topic: "韌性治理",
      question: "社會生態系韌性強調系統具備哪種能力？",
      choices: ["承受擾動並調整轉化", "完全避免所有變化", "永遠維持單一狀態", "排除人類制度因素"],
      answer: 0,
      explain: "韌性不是完全不變，而是在擾動下維持功能、學習調整，必要時轉型。"
    }
  ]
};
